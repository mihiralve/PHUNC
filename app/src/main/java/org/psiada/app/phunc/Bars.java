...
public class Bars extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Glide.with(getContext()).load("http://punc.psiada.org/wp-content/uploads/2018/03/cafe.jpg").diskCacheStrategy(DiskCacheStrategy.ALL).into(barImage1);
        ...
        Glide.with(getContext()).load("http://punc.psiada.org/wp-content/uploads/2018/03/champs.png").diskCacheStrategy(DiskCacheStrategy.ALL).into(barImage2);
        ...
        Glide.with(getContext()).load("http://punc.psiada.org/wp-content/uploads/2018/03/indigo.jpg").diskCacheStrategy(DiskCacheStrategy.ALL).into(barImage3);
        ...
        Glide.with(getContext()).load("http://punc.psiada.org/wp-content/uploads/2018/03/inferno.jpg").diskCacheStrategy(DiskCacheStrategy.ALL).into(barImage4);
        ...
        Glide.with(getContext()).load("http://punc.psiada.org/wp-content/uploads/2018/03/liberty.jpg").diskCacheStrategy(DiskCacheStrategy.ALL).into(barImage5);
        ...
        Glide.with(getContext()).load("http://punc.psiada.org/wp-content/uploads/2018/03/localwhiskey.jpg").diskCacheStrategy(DiskCacheStrategy.ALL).into(barImage6);
        ...
        Glide.with(getContext()).load("http://punc.psiada.org/wp-content/uploads/2018/03/madmex.jpg").diskCacheStrategy(DiskCacheStrategy.ALL).into(barImage7);
        ...
        Glide.with(getContext()).load("http://punc.psiada.org/wp-content/uploads/2018/03/phyrst.jpg").diskCacheStrategy(DiskCacheStrategy.ALL).into(barImage8);
        ...
        Glide.with(getContext()).load("http://punc.psiada.org/wp-content/uploads/2018/03/saloon.jpg").diskCacheStrategy(DiskCacheStrategy.ALL).into(barImage9);
        ...
        Glide.with(getContext()).load("http://punc.psiada.org/wp-content/uploads/2018/03/gaff.jpg").diskCacheStrategy(DiskCacheStrategy.ALL).into(barImage10);
        ...
        Glide.with(getContext()).load("http://punc.psiada.org/wp-content/uploads/2018/03/zenos.jpg").diskCacheStrategy(DiskCacheStrategy.ALL).into(barImage11);
